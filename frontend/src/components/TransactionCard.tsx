...
import { deposit, withdraw } from "./contract/zkPrivacy";
import { useEthersSigner } from "./contract/ethers";
import data from "./lib/abi/zkPrivacy.json";
...
const CONTRACT_ADDRESS = "0x8AcFc1486c28329502249E1f66685c9BC7f03c4f";  // zkPrivacy
